...
The primary function of the pressure sensor is to measure the rocket's altitude throughout its flight. 
...
While the pressure recorded by the sensor might look smooth at a first glance it becomes apparent that the minimal variations in the sensors measurements result in huge spikes when calculating the gradient.
...
The pressure sensor is the perfect sensor for determining the altitude during the flight accurately.
